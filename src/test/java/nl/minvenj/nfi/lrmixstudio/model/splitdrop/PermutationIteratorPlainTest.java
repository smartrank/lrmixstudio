...
public class PermutationIteratorPlainTest {
    ...
    private ArrayList<Locus> _possibleLoci;

    public PermutationIteratorPlainTest() {
    }
    ...
    /**
     * Test of hasNext method, of class PermutationIteratorPlain.
     */
    @Test
    public void testHasNext() {
        System.out.println("hasNext");
        PermutationIteratorPlain instance = new PermutationIteratorPlain(0, _possibleLoci, 0);
        assertFalse(instance.hasNext());
        PermutationIteratorPlain instance2 = new PermutationIteratorPlain(1, _possibleLoci, 0);
        assertTrue(instance2.hasNext());
    }

    /**
     * Test of next method, of class PermutationIteratorPlain.
     */
    @Test
    public void testNext() {
        System.out.println("next");
        PermutationIteratorPlain instance = new PermutationIteratorPlain(1, _possibleLoci, 0);
    ...
    private void testSize(int unknownCount, int start) {
        ...
        PermutationIteratorPlain instance = new PermutationIteratorPlain(unknownCount, _possibleLoci, start);
    ...
    /**
     * Test of size method, of class PermutationIteratorPlain.
     */
    @Test
